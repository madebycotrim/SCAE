        ...
        <div className="flex min-h-screen bg-slate-900 text-slate-100 font-sans">
            ...
            <aside className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col z-30">
                <div className="p-6 border-b border-slate-700 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-sm font-semibold tracking-wide text-white">SCAE <span className="text-indigo-400">CENTRAL</span></h1>
                ...
                <nav className="flex-1 p-4 space-y-1">
                    ...
                    >
                        <Building2 size={18} /> Escolas (escolas)
                    </NavLink>
                    <NavLink
                        to="/central/usuarios"
                        className={({ isActive }) =>
                ...
                <div className="p-4 border-t border-slate-700 flex flex-col gap-3">
                    <div className="bg-slate-700/50 rounded-lg p-3 border border-slate-700">
                        ...
                        <p className="text-sm font-medium text-white truncate">{usuarioAtual?.email?.split('@')[0] || 'central_root'}</p>
                    </div>
                    <button
                        onClick={logout}
