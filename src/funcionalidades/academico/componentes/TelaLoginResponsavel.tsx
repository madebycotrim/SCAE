/**
 * Tela de Autenticação para o Portal do Responsável (LGPD)
...
export default function TelaLoginResponsavel() {
    const { nomeEscola, id: slugEscola } = usarEscola();
    ...
    const lidarComBusca = async (e: React.FormEvent) => {
        ...
        if (matricula.trim() === '' || email.trim() === '') {
            toast.error('Preencha a matrícula e o e-mail completo.');
            return;
        }

        definirCarregando(true);
        try {
            await responsavelServico.autenticar(email, matricula);
            ...
            log.error('Falha na autenticação do responsável', error);
        } finally {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4">
            ...
            <div className="text-center mb-8">
                ...
                <h1 className="text-2xl font-black text-slate-800 tracking-tight">Portal do Responsável</h1>
