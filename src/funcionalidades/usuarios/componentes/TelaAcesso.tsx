                ...
                >
                    ...
                    <div className="md:w-[48%] p-14 flex flex-col items-center justify-center bg-white relative">
                        ...
                        <div className="max-w-[280px] w-full">
                            ...
                            {/* Botão SSO Dinâmico (Google ou Microsoft) */}
                            <button
                            ...
                            >
                                ...
                                <span className="text-[14px]">Entrar com {provedorAuth === 'microsoft' ? 'Microsoft Entra ID' : 'Google Workspace'}</span>
                            </button>

                            {/* Feedback de erro */}
                            {erro && (
                                <div className="mt-4 p-3 bg-rose-50 border border-rose-200 text-rose-600 text-xs font-bold rounded-2xl text-center flex items-center justify-center gap-2">
