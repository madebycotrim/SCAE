/**
 * FeedbackLeitura — Overlay visual pós-leitura de QR Code.
 * Exibe feedback verde (acesso liberado) ou vermelho (acesso negado)
 * com animação e informações do aluno.
 */
import { ShieldCheck, UserX, Clock } from 'lucide-react';

/**
 * @param {Object} props
 * @param {Object} props.registro - Dados da última leitura
 ...
 * @param {string} props.registro.hora - Horário da leitura (HH:mm:ss)
 */
                ...
                {registro.aluno && (
                    <div className="mb-4">
                        ...
                        <p className="text-white/60 font-mono text-sm">
                            {registro.aluno.matricula} • Turma {registro.aluno.turma_id}
                        </p>
                    </div>
                )}
